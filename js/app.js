document.addEventListener("DOMContentLoaded", (function() {
    ...
    function f() {
        t && (g = !0, p = window.scrollY, t.style.display = "block", document.body.style.overflow = "hidden", a.style.display = "none", c.style.display = "none")
    }

    function v() {
        t && g && (g = !1, t.style.display = "none", document.body.style.overflow = "", document.body.style.position = "", document.body.style.top = "", window.scrollTo(0, p))
    }
    e.forEach((e => e.addEventListener("click", f))), n && n.addEventListener("click", v), o && o.addEventListener("click", v), d.addEventListener("submit", (function(e) {
        ...
        const t = l.value.trim(),
            n = r.value.trim();
        let o = !1;
        if (t ? a.style.display = "none" : (a.style.display = "block", o = !0), E.validate(n) ? c.style.display = "none" : (c.style.display = "block", o = !0), o) return;
        ...
        localStorage.setItem("formData", JSON.stringify(u)), window.location.href = "/thankYou.html", i.textContent = "DAVOM ETISH", i.disabled = !1, l.value = "", r.value = "", v()
    }))
})), document.addEventListener("DOMContentLoaded", (function() {
